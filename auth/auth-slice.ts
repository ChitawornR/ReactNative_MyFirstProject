...
export const authSlice = createSlice({
  ...
  reducers: {
    setIsLogin(state, action: PayloadAction<any | null>) {
      state.isLogin = action.payload; // to update global state
    },
    setIsLoading(state, action: PayloadAction<any | null>) {
      state.isLoading = action.payload; // to update global state
    },
    setProfile(state, action: PayloadAction<any | null>) {
      state.profile = action.payload; // to update global state
    },
  },
});
